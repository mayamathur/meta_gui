            ...
            tabPanel("Sensitivity analysis for the percentage of meaningfully strong effects",
                     ...
                     wellPanel(  HTML(paste(
                      ...
                      <br><br><b>Sensitivity analysis for the percentage of meaningfully strong causal effects</b>
                       ...
                       Below these three metrics appears a plot of the estimated proportion of meaningfully strong causal effects as a functino of the severity of bias.,
                                  ...
                                  fluidRow(
                                    ...
                                    shinydashboard::box(width=6,
                                                        ...
                                                        column(width=10,
                                                               ...
                                                               numericInput('calibrated_muB', 'Bias factor in each study (on scale you specified)', 1.5, min = 0, max = Inf, step = 0.01) %>%
                                                                 shinyInput_label_embed(
                                                                   shiny_iconlink() %>%
